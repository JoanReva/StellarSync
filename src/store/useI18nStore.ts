...
const translations = {
  en: {
    ...
    scoreNamePlaceholder: 'Your name',
    saveScore: 'Save score',
    savingScore: 'Saving',
    scoreSaved: 'Score saved',
    scoreUnavailable: 'Connect Supabase to save and load the scoreboard.',
    scoreLoading: 'Loading scores',
    scoreLoadError: 'Scores could not be loaded.',
    scoreSubmitError: 'Your score could not be saved.',
    noScoresYet: 'No scores yet.',
    scoreRowStats: '{time}s',
    scoreRules: 'Ranked by time left from a {time}s round.',
  },
  es: {
    start: 'Comenzar',
    ...
    scoreNamePlaceholder: 'Tu nombre',
    saveScore: 'Guardar',
    savingScore: 'Guardando',
    scoreSaved: 'Puntaje guardado',
    scoreUnavailable: 'Conecta Supabase para guardar y cargar el marcador.',
    scoreLoading: 'Cargando puntajes',
    scoreLoadError: 'No se pudieron cargar los puntajes.',
    scoreSubmitError: 'No se pudo guardar tu puntaje.',
    noScoresYet: 'A\u00fan no hay puntajes.',
    scoreRowStats: '{time}s',
    scoreRules: 'Ordenado por tiempo restante de una ronda de {time}s.',
  },
};

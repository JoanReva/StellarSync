  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-white text-lg font-bold text-[var(--color-text-main)] shadow-xl ring-2 ring-white/70 transition duration-200 hover:scale-105 hover:bg-[var(--color-bg-secondary)] focus:outline-none focus:ring-4 focus:ring-[var(--color-primary)] focus:ring-offset-2"
      >
        Aa
      </button>

      {isOpen && (
        <div className="absolute right-0 mt-3 w-64 rounded-2xl bg-white p-4 text-left shadow-2xl ring-1 ring-slate-200">
